...
#+begin_src elisp
    ...
    (set-face-attribute 'org-level-1 nil :foreground "#ebdbb2" :underline nil :extend t :height 1.5 :weight 'bold)
    (set-face-attribute 'org-level-2 nil :foreground "#ebdbb2" :underline nil :extend t :height 1.5 :weight 'bold)
    (set-face-attribute 'org-level-3 nil :foreground "#ebdbb2" :underline nil :extend t :height 1.5 :weight 'bold)
    (set-face-attribute 'org-level-4 nil :foreground "#ebdbb2" :underline nil :extend t :height 1.5 :weight 'bold)
    (set-face-attribute 'org-level-5 nil :foreground "#ebdbb2" :underline nil :extend t :height 1.5 :weight 'bold)
    (set-face-attribute 'org-level-6 nil :foreground "#ebdbb2" :underline nil :extend t :height 1.5 :weight 'bold)
    (set-face-attribute 'org-level-7 nil :foreground "#ebdbb2" :underline nil :extend t :height 1.5 :weight 'bold)
